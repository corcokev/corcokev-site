...
const Experience = ({ setSelectedPage }: Props) => {
  return (
    <section id="experience" className="gap-16 bg-secondary py-3 md:h-full">
      <motion.div onViewportEnter={() => setSelectedPage(Page.Experience)}>
              ...
              <ul>
                <li>
                  <p className="text-lg text-gray-300">
                    ...
                    adopted by 65+ AWS teams to safely automate Availability
                    Zone deployments.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p className="text-lg text-gray-300">
                    ...
                    including a localization service that delivers ~20% of text
                    on the Amazon shopping page.
                  </p>
                </li>
                <li>
                  <p className="text-lg text-gray-300">
              ...
              <ul>
                ...
                <li>
                  <p className="text-xl text-gray-300">
                    ...
                    in an existing codebase, improving stability and
                    reliability.
                  </p>
                </li>
                <li>
